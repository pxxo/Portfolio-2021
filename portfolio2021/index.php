...
<body id="top">
  ...
  <div class="displayMenu" id="displayMenu">
    <!-- <div id="humburgerIco">
      <img src="img/humburger.jpg" alt="" class="humburgerIco">
    </div> -->
  ...
  <div id="all">
    <div class="change" id="allDisplay">
      ...
      <div class="black">
        ...
        <section class="scroll">
          <div>
            <a href="#notice">
              <p></p>
              <img src="img/scroll-icon.jpg" alt="">
            </a>
          </div>
        </section>
      ...
      <div class="airbox">
        <img src="img/triangle.jpg" alt="" class="triangle-black">
      </div>
      ...
      <footer id="footer">
        <img src="img/triangle-white.jpg" alt="" class="triangle-white">
        <div class="center02">
          ...
          <div class="inline04" data-aos="fade-up" data-aos-offset="200" data-aos-duration="500">
            ...
            <div class="line02"></div>
            <ul>
              <li><a href="https://twitter.com/novact_kosei" target="_blank" rel="noopener noreferrer">> Twitter</a></li>
