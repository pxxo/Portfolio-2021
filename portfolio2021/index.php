...
<body id="top">
  ...
  <div class="change" id="allDisplay">
    ...
    <div class="black">
      ...
      <!-- <section class="codingxdesign" data-aos-offset="500" data-aos-duration="500">
        <div class="center">
          <h1 class="codingxdesign-title" id="codingxdesign">coding</h1><br class="disabled02">
          <h1 class="codingxdesign-title">×</h1><br class="disabled02">
          <h1 class="codingxdesign-title">design</h1>
        </div>
        <div class="center">
          <a href=""></a><img src="img/html-icon.png" alt="" class="language-icon">
          <img src="img/css-icon.png" alt="" class="language-icon">
          <img src="img/js-icon.png" alt="" class="language-icon">
          <img src="img/php-icon.png" alt="" class="language-icon">
        </div>
      </section> -->
